...
public sealed class TileNode
{
    ...
    /// <remarks>Echoed for a terminal agent tile as well, and that is the other half of its rollback: without a
    ...
    {
        get => Echo(TileKindIds.Terminal, "shellName") ?? Echo(TileKindIds.TerminalAgent, "shellName");
