...
else), and announces what it can do by which of five interfaces extending it it implements: `IBusyTile`
...
an Enter land), `ICustomBackgroundTile` (the terminal's inset and its own background colour). **One class
